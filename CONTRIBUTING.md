...
- Catalog agents stay these four slugs: `default-assistant`, `supervisor`,
  `science-specialist`, `retrieval-specialist`.
- Do not name product foresight RAP. Do not present ToolWorld-v1 as ALFWorld.
...
measured numbers change. Do not commit `.env`, `*.db`, or cache directories.
