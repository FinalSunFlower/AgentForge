...
![Routed world-model pipeline](figures/architecture.jpg)
...
![Cost versus success](figures/cost_quality.png)
...
![Gate / router ablation](figures/ablation.png)
![Expert-count curve](figures/expert_count.png)
...
![Household cost versus success](figures/household_cost_quality.png)
